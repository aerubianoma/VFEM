function [edges2nodes, edges2elems, elems2edges, nodes2edges]=getEdges(elems2nodes)
...
%add on
edges2elems=entryInWhichRows(elems2edges); 
if (size(edges2elems,2)==1)
    edges2elems=[edges2elems 0*edges2elems];    %all edges are boundary edges!!!
end 
nodes2edges=entryInWhichRows(edges2nodes); 
