function [nodes2coord,elems2nodes,dirichlet,neumann]=refinement_uniform_2D(nodes2coord,elems2nodes,dirichlet,neumann) 
...
%elements of uniformly refined mesh
...
%dirichlet edges of uniformly refined mesh
    if ~isempty(neumann)
        ...
        neumann=[neumann(:,1) neumann_edges+size(nodes2coord,1); neumann_edges+size(nodes2coord,1) neumann(:,2)];
    end
end
