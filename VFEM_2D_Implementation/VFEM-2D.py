# This is a modified version from the code in https://github.com/justachetan/VirtualElementMethods
# By: Andres Rubiano
...
def main():
    meshes = ['L-domain','non-convex','smoothed-voronoi','square','triangles','voronoi']
    ...
    for mesh in meshes:
        ...
        plot_solution(mesh_file, u, True, 'solution')
